$(document).ready(function() {
    ...
    */
    function addNumbers(num1,num2){
        document.getElementById("num1","num2").innerHTML=addNumbers;
        $("#result-add").append('<div></div>');
    ...
    */
    function multiplyNumbers(num1,num2){
        document.getElementbById("num1","num2").innerHTML=multiplyNumbers;
        $("#result-mult").append('<div></div>');
